    ...
    <Routes>
      ...
      <Route path='/bank'>
        ...
        <Route path='transaction'>
          ...
          <Route path='update' element={<EditTransaction {...editTransaction.bank.add} />} />
        </Route>
      ...
      <Route path='/creditcard'>
        ...
        <Route path='transaction'>
          ...
          <Route path='update' element={<EditTransaction {...editTransaction.creditCard.add} />} />
        </Route>
      ...
      <Route path='/stock'>
        ...
        <Route path='transaction'>
          ...
          <Route path='update' element={<EditTransaction {...editTransaction.stock.add} />} />
        </Route>
      ...
      <Route path='/mutualfund'>
        ...
        <Route path='transaction'>
          ...
          <Route path='update' element={<EditTransaction {...editTransaction.mutualFund.add} />} />
        </Route>
      ...
      <Route path='/misc'>
        ...
        <Route path='transaction'>
          ...
          <Route path='update' element={<EditTransaction {...editTransaction.misc.add} />} />
        </Route>
